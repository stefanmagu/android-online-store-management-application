...
public class ProduseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        llMonitor = findViewById(R.id.llMonitor);
        ...
        llFrigider.setOnClickListener(view -> {
            Intent intentFrigider = new Intent(getApplicationContext(), FrigidereActivity.class);
            startActivity(intentFrigider);
        });
        llMonitor.setOnClickListener(view -> {
            Intent intentMonitor = new Intent(getApplicationContext(), MonitoareActivity.class);
